...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('  ║       BOLETA DE PAGO - PUNTOTICKET   ║');
    DBMS_OUTPUT.PUT_LINE('  ╠══════════════════════════════════════╣');
    DBMS_OUTPUT.PUT_LINE('  ║                                      ║');
    DBMS_OUTPUT.PUT_LINE('  ║  Cliente : ' || RPAD(v_boleta_cliente.nombre_cliente, 26) || '║');
    DBMS_OUTPUT.PUT_LINE('  ║  ──────────────────────────────────  ║');
    DBMS_OUTPUT.PUT_LINE('  ║  Monto Bruto     $' || LPAD(TO_CHAR(v_boleta_cliente.monto_bruto, '999G990'), 15) || '    ║');
    DBMS_OUTPUT.PUT_LINE('  ║  Descuento      -$' || LPAD(TO_CHAR(v_boleta_cliente.descuento_aplicado, '999G990'), 15) || '    ║');
    DBMS_OUTPUT.PUT_LINE('  ║  ──────────────────────────────────  ║');
    DBMS_OUTPUT.PUT_LINE('  ║  TOTAL PAGADO    $' || LPAD(TO_CHAR(v_boleta_cliente.monto_final_pagado, '999G990'), 15) || '    ║');
    DBMS_OUTPUT.PUT_LINE('  ║                                      ║');
    DBMS_OUTPUT.PUT_LINE('  ║  Estado : ' || RPAD(v_boleta_cliente.estado_pago, 26) || ' ║');
    DBMS_OUTPUT.PUT_LINE('  ║                                      ║');
    DBMS_OUTPUT.PUT_LINE('  ╚══════════════════════════════════════╝');
